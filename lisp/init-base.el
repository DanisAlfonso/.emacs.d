...
(setq user-full-name danis-full-name
      user-mail-address danis-mail-address)
...
(when (display-graphic-p)
  ...
  (bind-keys ("C-M-<return>"    . danis-frame-maximize)
             ("C-M-<backspace>" . danis-frame-restore)
             ("C-M-<left>"      . danis-frame-left-half)
             ("C-M-<right>"     . danis-frame-right-half)
             ("C-M-<up>"        . danis-frame-top-half)
             ("C-M-<down>"      . danis-frame-bottom-half))
