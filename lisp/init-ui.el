...
(when (display-graphic-p)
  ...
  ;; Theme
  (if (danis-compatible-theme-p danis-theme)
      (progn
        ...
        (use-package doom-themes
          ...
          :init (danis-load-theme danis-theme t)
          :config
    ...
    (progn
      ...
      (danis-load-theme danis-theme t)))

  ;; Mode-line
  (use-package doom-modeline
    :hook (after-init . doom-modeline-mode)
    :init
    (setq doom-modeline-icon danis-icon
...
;; Ligatures support
(when (and emacs/>=28p (not danis-prettify-symbols-alist))
