...
(use-package org
  ...
  :hook (((org-babel-after-execute org-mode) . org-redisplay-inline-images) ; display image
         (org-mode . (lambda ()
                       ...
                       (when danis-prettify-org-symbols-alist
                         (if prettify-symbols-alist
                             (push danis-prettify-org-symbols-alist prettify-symbols-alist)
                           (setq prettify-symbols-alist danis-prettify-org-symbols-alist)))
...
prepended to the element after the #+HEADER: tag."
  ...
  (setq org-modules nil                 ; Faster loading
        org-directory danis-org-directory
        ...
        ;; Agenda styling
        org-agenda-files (list danis-org-directory)
  ...
  (when (featurep 'xwidget-internal)
    (push '("\\.\\(x?html?\\|pdf\\)\\'"
            .
            (lambda (file _link)
              (danis-webkit-browse-url (concat "file://" file) t)))
          org-file-apps))
...
(use-package org-roam
  ...
  :init
  (setq org-roam-directory (file-truename danis-org-directory)
